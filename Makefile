...
ACLOCAL = ${SHELL} /root/fuse-tutorial-2016-03-25/missing aclocal-1.14
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} /root/fuse-tutorial-2016-03-25/missing autoconf
AUTOHEADER = ${SHELL} /root/fuse-tutorial-2016-03-25/missing autoheader
AUTOMAKE = ${SHELL} /root/fuse-tutorial-2016-03-25/missing automake-1.14
AWK = gawk
CC = gcc
...
LIBS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /root/fuse-tutorial-2016-03-25/missing makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
...
STRIP = 
VERSION = 2016-03-25
abs_builddir = /root/fuse-tutorial-2016-03-25
abs_srcdir = /root/fuse-tutorial-2016-03-25
abs_top_builddir = /root/fuse-tutorial-2016-03-25
abs_top_srcdir = /root/fuse-tutorial-2016-03-25
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /root/fuse-tutorial-2016-03-25/install-sh
